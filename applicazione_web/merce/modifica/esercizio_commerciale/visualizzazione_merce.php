<?php
	...
	if($_SESSION["ruolo"] != "Esercizio commerciale")
	{
		header("location: ../../../homepage.php");
	}
?>
	...
	<body>
		...
		<div id="myBarraLaterale" class="barraLaterale" >
			...
			<?php
				echo "<a href='javascript:void(0)' onclick='sottomenu()' ><i class='fas fa-user' ></i> " . $_SESSION["username"] ."</a>
					  ...
					  <a href='visualizzazione_merce.php' >Visualizza consegne <i class='far fa-clipboard'></i></a>";
			?>
		...
		<div id='listaConsegne'>
			...
			<?php
				...
				$qry = "SELECT *
						FROM merce
						WHERE fk_destinatario ='".$_SESSION["id_azienda"]."';";
				...
				if($ris)
				{
					if($ris->num_rows)
					{
						while($riga = $ris->fetch_row())
						{
							...
							if($riga[16] == '')
							{
								$riga[16] = 'Valore non inserito';
							}
							
							if($riga[18] == '')
							{
								$riga[18] = 'Valore non inserito';
							}
							...
							echo "<label>ID merce</label>
								  ...
								  <input value='$riga[15]' disabled>
								  <input type='hidden' value='$riga[15]' name='merce_inserita_da' ><br><br>
								  
								  <label>Numero di telefono fornitore</label>
								  <input value='$riga2[1]' disabled>
								  <input type='hidden' value='$riga2[1]' name='telefono_fornitore' ><br><br>
								  
								  <label>Merce inserita dall'azienda</label>
								  <input value='$riga2[0]' disabled>
								  <input type='hidden' value='$riga2[0]' name='nome_azienda_merce_inserita' ><br><br><br><br><br>";
						}
					}
