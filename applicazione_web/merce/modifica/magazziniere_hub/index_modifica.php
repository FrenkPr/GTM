		...
		<div id='consegna'>
			...
			<?php
				...
				echo "<form action='modifica.php' method='post'>
						  ...
						  <input value='".$_POST["num_scaffale"]."' disabled>
						  &nbsp;<input class='dati' placeholder='Modifica dato' name='num_scaffale' maxlength='10'><br><br>
						  
						  <label>Data di consegna all'HUB</label>
						  <input value='$data_hub_italiana[2]/$data_hub_italiana[1]/$data_hub_italiana[0]' disabled>
						  <input type='hidden' id='consegnaHub' value='".$_POST["consegna_hub"]."' disabled><br><br>
						  
						  <label>Data di consegna all'esercizio commerciale</label>
						  <input value='".$_POST["consegna_es_comm"]."' disabled>
						  &nbsp;<input type='date' class='dati' id='consegnaEsComm' name='consegna_es_comm'>
						  <label id='errConsegnaEsComm' style='color:red'></label><br><br>
						  ...
						  <select class='dati' name='stato'>
							  ...
							  <option>Arrivato all'HUB</option>
						  ...
						  <label>Merce inserita da</label>
						  <input value='".$_POST["merce_inserita_da"]."' disabled><br><br>
						  
						  <label>Numero di telefono fornitore</label>
						  <input value='".$_POST["telefono_fornitore"]."' disabled><br><br>
						  
						  <label>Merce inserita dall'azienda</label>
						  <input value='".$_POST["nome_azienda_merce_inserita"]."' disabled><br><br>
						  
						  <label>Corriere</label>
						  <input value='".$_POST["corriere"]."' disabled>&nbsp;
						  
						  <select class='dati' id='corriere' name='corriere'>
							  <option value=''>Modifica dato</option>";
						  ...
						  echo "</select>
								...
								<select class='dati' id='targa' name='targa'>
									<option value=''>Modifica dato</option>";
