<?php
	...
	if($_SESSION["ruolo"] != "Magazziniere HUB")
	{
		header("location: ../../../homepage.php");
	}
?>
					...
					if($ris->num_rows)
					{
						while($riga = $ris->fetch_row())
						{
							...
							echo "<form action='index_modifica.php' method='post'>
									  ...
									  <input type='hidden' value='$riga[10]' name='num_scaffale' ><br><br>
									  ...
									  <input value='$riga[16]' disabled>
									  <input type='hidden' value='$riga[16]' name='corriere' ><br><br>
