...
<html lang = "it" >
	...
	<body>
		...
		<div class="box" >
			...
			<h2>Chi siamo?</h2>
			<p>
				Siamo un'azienda specializzata nella gestione dei trasporti a Firenze, con l'utilizzo di veicoli elettrici di
				piccole dimensioni.
			</p>
			<h2>Che cosa facciamo?</h2>
			<p>
				Spediamo la merce agli esercizi commerciali situati nel centro storico di Firenze.
				Il nostro sito permette ai fornitori e agli esercizi commerciali di controllare le spedizioni della merce.
			</p>
		</div>
	</body>
</html>